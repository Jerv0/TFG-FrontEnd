...
//https://m2.material.io/icons/ de aqui sacais iconos
...
<template>
  ...
  <q-drawer
    ...
    v-if="currentRoute != '/' && currentRoute != '/Register' && currentRoute != '/Login'"
    show-if-above
    bordered
  >
    ...
    >
      <div class="absolute-bottom bg-transparent">
        ...
        <div class="apellido">@{{ data.username }}</div>
      </div>
    </q-img>
    ...
    >
      ...
      <q-list padding v-if="data?.usertype === 'admin'">
        <q-item-label header> Informacion </q-item-label>
        <q-item clickable v-ripple to="/admin" active-class="my-menu-link"
          ><q-item-section> Inicio </q-item-section>
        </q-item>
        <q-item clickable v-ripple to="/candidaturas" active-class="my-menu-link"
          ><q-item-section> Candidatos </q-item-section>
        </q-item>
        <q-item clickable v-ripple to="/ver/paciente" active-class="my-menu-link"
          ><q-item-section> Pacientes </q-item-section>
        </q-item>
        <q-item clickable v-ripple to="/ver/supervisor" active-class="my-menu-link"
          ><q-item-section> Supervisor </q-item-section>
        </q-item>
      </q-list>

      <q-list padding v-if="data?.usertype === 'paciente'">
