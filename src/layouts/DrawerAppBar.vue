  ...
  >
    ...
    >
      ...
      <q-list padding v-if="prueba?.usertype === 'admin'">
        ...
        <q-item clickable v-ripple to="/admin" active-class="my-menu-link"><q-item-section> Inicio </q-item-section>
        </q-item>

        <q-item clickable v-ripple to="/candidaturas" active-class="my-menu-link"><q-item-section> Candidatos </q-item-section>
        </q-item>

        <q-item clickable v-ripple to="/ver/paciente" active-class="my-menu-link"><q-item-section> Pacientes </q-item-section>
        </q-item>

        <q-item clickable v-ripple to="/ver/supervisor" active-class="my-menu-link"><q-item-section> Supervisor </q-item-section>
        </q-item>
      </q-list>
      ...
      <q-list padding v-if="prueba?.usertype === 'supervisor'">
        ...
        <q-item clickable v-ripple to="/supervisor" active-class="my-menu-link"><q-item-section> Inicio </q-item-section>
        </q-item>

        <q-item clickable v-ripple to="/revisionTareas" active-class="my-menu-link"><q-item-section> Revisar tareas </q-item-section>
        </q-item>

        <q-item clickable v-ripple to="/verDatos" active-class="my-menu-link"><q-item-section> Perfil </q-item-section>
        </q-item>
