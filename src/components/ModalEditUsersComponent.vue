...
const onSubmit = () => {
    ...
    axios.put(`https://${import.meta.env.VITE_RUTA}/${import.meta.env.VITE_BACKEND}/userJavi?id=${props.row.id}`, dataUser);
    axios.put(`https://${import.meta.env.VITE_RUTA}/${import.meta.env.VITE_BACKEND}/pacienteJavi?id=${props.row.id}`, dataCustom);
...
<template>
    <div class="q-pa-md q-gutter-sm">
        <q-btn icon="edit" color="primary" @click="openDialog" />

        <q-dialog v-model="persistent" transition-show="scale" transition-hide="scale">
            <q-card class="bg-light text-dark" style="max-width: 600px; width: 100%">
                <q-card-section>
                ...
                <q-form @submit.prevent="onSubmit" class="q-gutter-md q-pa-md">
                    ...
                    <div class="row q-col-gutter-md">
                        <q-input v-model="form.pass" label="Password" type="password" filled class="col-6" />
                    ...
                    <div class="row q-col-gutter-md">
                        ...
                        <q-input v-model="form.token" label="Token" filled class="col-6" />
                    </div>
